...
#ifndef __sobel_mul_mul_12nKfY__HH__
#define __sobel_mul_mul_12nKfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_mul_12nKfY) {
    ...
    SC_CTOR(sobel_mul_mul_12nKfY):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
