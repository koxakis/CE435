...
$(ObjDir)/sobel_test.c_pre.c.tb.o : sobel_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) sobel_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sobel_opt.c_pre.c.tb.o : sobel_opt.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) sobel_opt.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
