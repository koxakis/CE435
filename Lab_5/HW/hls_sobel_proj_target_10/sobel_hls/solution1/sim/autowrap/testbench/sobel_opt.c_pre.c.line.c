#pragma line 1 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c"
...
#pragma empty_line
#pragma line 2 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c" 2
...
#pragma empty_line
#pragma line 3 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c" 2
...
#pragma empty_line
#pragma line 4 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c" 2
...
#pragma line 5 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c" 2
#pragma line 15 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c"
int convolution2D_horiz(int posy, int posx, const unsigned char input[1024*1024]) {
 int res;
 int posy0 = (posy - 1)*1024;
 int posy1 = posy*1024;
 int posy2 = (posy + 1)*1024;
 int posx0 = posx - 1;
 int posx2 = posx + 1;
 res = 0;
#pragma empty_line
 res += input[posy0 + posx0] * (-1);
#pragma empty_line
 res += input[posy0 + posx2];
#pragma empty_line
 res += input[posy1 + posx0] * (-2);
#pragma empty_line
 res += input[posy1 + posx2] << 1;
#pragma empty_line
 res += input[posy2 + posx0] * (-1);
#pragma empty_line
 res += input[posy2 + posx2];
#pragma empty_line
 return res;
}
#pragma empty_line
#pragma empty_line
int convolution2D_vert(int posy, int posx, const unsigned char input[1024*1024]) {
#pragma empty_line
 int res;
 int posy0 = (posy - 1)*1024;
 int posy2 = (posy + 1)*1024;
...
#pragma empty_line
 res = 0;
#pragma empty_line
 res += input[posy0 + posx0];
 res += input[posy0 + posx] << 1;
 res += input[posy0 + posx2];
#pragma empty_line
#pragma empty_line
#pragma empty_line
...
#pragma empty_line
 res += input[posy2 + posx0] * (-1);
 res += input[posy2 + posx] * (-2);
 res += input[posy2 + posx2] * (-1);
#pragma empty_line
 return res;
}
#pragma empty_line
...
#pragma line 91 "/home/inf2013/nxiromeritis/embedded/ce435_5/hls_sobel_proj/sobel_opt.c"
