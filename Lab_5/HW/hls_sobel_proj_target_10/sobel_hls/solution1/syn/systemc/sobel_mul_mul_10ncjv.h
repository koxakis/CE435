...
#ifndef __sobel_mul_mul_10ncjv__HH__
#define __sobel_mul_mul_10ncjv__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_mul_10ncjv) {
    ...
    SC_CTOR(sobel_mul_mul_10ncjv):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
