...
#ifndef __sobel_mul_mul_11nckv__HH__
#define __sobel_mul_mul_11nckv__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_mul_11nckv) {
    ...
    SC_CTOR(sobel_mul_mul_11nckv):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
