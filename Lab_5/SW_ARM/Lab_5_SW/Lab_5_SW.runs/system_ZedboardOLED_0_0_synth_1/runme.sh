...
HD_PWD='/run/media/nikolas/Linux_Data/Git_Repos/CE435/Lab_5/Sobel_SW/Lab_5_SW/Lab_5_SW.runs/system_ZedboardOLED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ZedboardOLED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ZedboardOLED_0_0.tcl
