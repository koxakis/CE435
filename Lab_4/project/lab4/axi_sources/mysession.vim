...
map Oj *
map Oo :
nnoremap ,h :setlocal keymap=greek_utf-8:setlocal spell spelllang=el
nnoremap ,e :setlocal keymap=:setlocal spell spelllang=en,el
nnoremap ,g :setlocal keymap=greek_utf-8:setlocal spell spelllang=en,el
...
silent only
cd ~/embedded/ce435_4/lab4/axi_sources
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 xmult_driver.c
badd +451 xmult_ip_v1_0_S_AXI.v
badd +1 xmult_main.c
badd +0 godlyaxibackup.v
argglobal
silent! argdel *
argadd xmult_driver.c
edit xmult_driver.c
...
exe 'vert 1resize ' . ((&columns * 113 + 118) / 237)
exe '2resize ' . ((&lines * 34 + 36) / 73)
exe 'vert 2resize ' . ((&columns * 113 + 118) / 237)
exe 'vert 3resize ' . ((&columns * 123 + 118) / 237)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
1
normal! 0
lcd ~/embedded/ce435_4/lab4/axi_sources
wincmd w
argglobal
edit ~/embedded/ce435_4/lab4/axi_sources/xmult_main.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 29 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
wincmd w
argglobal
edit ~/embedded/ce435_4/lab4/axi_sources/godlyaxibackup.v
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 664 - ((69 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
664
