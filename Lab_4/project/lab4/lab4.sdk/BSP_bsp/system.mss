...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -g -pg -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = xmult_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xmult_ip_0
END
