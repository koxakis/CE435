...
HD_PWD='/run/media/nikolas/Linux_Data/CE435_vidado_labs/Lab_4/project/lab4/lab4.runs/block_diagram_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_diagram_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_diagram_axi_gpio_0_1.tcl
