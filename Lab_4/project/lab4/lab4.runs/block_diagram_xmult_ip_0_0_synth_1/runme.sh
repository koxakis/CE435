...
HD_PWD='/run/media/nikolas/Linux_Data/CE435_vidado_labs/Lab_4/project/lab4/lab4.runs/block_diagram_xmult_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_diagram_xmult_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_diagram_xmult_ip_0_0.tcl
