...
HD_PWD='/run/media/nikolas/Linux_Data/CE435_vidado_labs/Lab_2/step_1/project/lab2_simple_arm/lab2_simple_arm.runs/lab2_simple_arm_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_simple_arm_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_simple_arm_auto_pc_0.tcl
