...
#ifndef __sobel_mul_mul_11nMgi__HH__
#define __sobel_mul_mul_11nMgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_mul_11nMgi) {
    ...
    SC_CTOR(sobel_mul_mul_11nMgi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
