...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sobel.autotvin_XSOBEL_INPUT_BUS.dat"
         "c.sobel.autotvin_input_r.dat"
         "c.sobel.autotvin_output_r.dat"
         "c.sobel.autotvout_XSOBEL_OUTPUT_BUS.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sobel.autotvout_XSOBEL_OUTPUT_BUS.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
