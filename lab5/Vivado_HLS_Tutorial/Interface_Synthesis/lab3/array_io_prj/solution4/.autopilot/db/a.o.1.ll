; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab3/array_io_prj/solution4/.autopilot/db/a.g.1.bc'
...
define void @array_io(i16* %d_o, i16* %d_i) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition(i16* %d_i, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  call void (...)* @_ssdm_SpecArrayPartition(i16* %d_o, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !45 ; [debug line = 58:1]
