; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab3/array_io_prj/solution3/.autopilot/db/a.o.bc'
...
define void @array_io(i16* %d_o, i16* %d_i) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition(i16* %5, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  %6 = load i16** %1, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_SpecArrayPartition(i16* %6, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 4, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  ...
  %8 = load i16** %2, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecResource(i16* %8, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
...
; <label>:13                                      ; preds = %10
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !53 ; [debug line = 64:35]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !53 ; [debug line = 64:35]
  ...
  %14 = load i32* %i, align 4, !dbg !56           ; [#uses=1 type=i32] [debug line = 65:3]
  %15 = srem i32 %14, 8, !dbg !56                 ; [#uses=1 type=i32] [debug line = 65:3]
  store i32 %15, i32* %rem, align 4, !dbg !56     ; [debug line = 65:3]
  %16 = load i32* %rem, align 4, !dbg !57         ; [#uses=1 type=i32] [debug line = 66:3]
  %17 = sext i32 %16 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 66:3]
  %18 = getelementptr inbounds [8 x i32]* @array_io.acc, i32 0, i64 %17, !dbg !57 ; [#uses=1 type=i32*] [debug line = 66:3]
  %19 = load i32* %18, align 4, !dbg !57          ; [#uses=1 type=i32] [debug line = 66:3]
  %20 = load i32* %i, align 4, !dbg !57           ; [#uses=1 type=i32] [debug line = 66:3]
  %21 = sext i32 %20 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 66:3]
  %22 = load i16** %2, align 8, !dbg !57          ; [#uses=1 type=i16*] [debug line = 66:3]
  %23 = getelementptr inbounds i16* %22, i64 %21, !dbg !57 ; [#uses=1 type=i16*] [debug line = 66:3]
  %24 = load i16* %23, align 2, !dbg !57          ; [#uses=1 type=i16] [debug line = 66:3]
  %25 = sext i16 %24 to i32, !dbg !57             ; [#uses=1 type=i32] [debug line = 66:3]
  %26 = add nsw i32 %19, %25, !dbg !57            ; [#uses=1 type=i32] [debug line = 66:3]
  %27 = load i32* %rem, align 4, !dbg !57         ; [#uses=1 type=i32] [debug line = 66:3]
  %28 = sext i32 %27 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 66:3]
  %29 = getelementptr inbounds [8 x i32]* @array_io.acc, i32 0, i64 %28, !dbg !57 ; [#uses=1 type=i32*] [debug line = 66:3]
  store i32 %26, i32* %29, align 4, !dbg !57      ; [debug line = 66:3]
  %30 = load i32* %rem, align 4, !dbg !58         ; [#uses=1 type=i32] [debug line = 67:3]
  %31 = sext i32 %30 to i64, !dbg !58             ; [#uses=1 type=i64] [debug line = 67:3]
  %32 = getelementptr inbounds [8 x i32]* @array_io.acc, i32 0, i64 %31, !dbg !58 ; [#uses=1 type=i32*] [debug line = 67:3]
  %33 = load i32* %32, align 4, !dbg !58          ; [#uses=1 type=i32] [debug line = 67:3]
  %34 = trunc i32 %33 to i16, !dbg !58            ; [#uses=1 type=i16] [debug line = 67:3]
  %35 = load i32* %i, align 4, !dbg !58           ; [#uses=1 type=i32] [debug line = 67:3]
  %36 = sext i32 %35 to i64, !dbg !58             ; [#uses=1 type=i64] [debug line = 67:3]
  %37 = load i16** %1, align 8, !dbg !58          ; [#uses=1 type=i16*] [debug line = 67:3]
  %38 = getelementptr inbounds i16* %37, i64 %36, !dbg !58 ; [#uses=1 type=i16*] [debug line = 67:3]
  store i16 %34, i16* %38, align 2, !dbg !58      ; [debug line = 67:3]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !59 ; [debug line = 68:2]
  br label %39, !dbg !59                          ; [debug line = 68:2]

; <label>:39                                      ; preds = %13
  %40 = load i32* %i, align 4, !dbg !60           ; [#uses=1 type=i32] [debug line = 64:29]
  %41 = add nsw i32 %40, 1, !dbg !60              ; [#uses=1 type=i32] [debug line = 64:29]
  store i32 %41, i32* %i, align 4, !dbg !60       ; [debug line = 64:29]
  br label %10, !dbg !60                          ; [debug line = 64:29]
