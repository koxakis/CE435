; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab3/array_io_prj/solution2/.autopilot/db/a.o.bc'
...
define void @array_io(i16* %d_o, i16* %d_i) nounwind uwtable {
  %1 = alloca i16*, align 8                       ; [#uses=4 type=i16**]
  ...
  %5 = load i16** %1, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %5, i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  %6 = load i16** %2, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecResource(i16* %6, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  ...
  br label %7, !dbg !50                           ; [debug line = 61:22]

; <label>:7                                       ; preds = %0
  store i32 0, i32* %i, align 4, !dbg !51         ; [debug line = 64:17]
  br label %8, !dbg !51                           ; [debug line = 64:17]

; <label>:8                                       ; preds = %37, %7
  %9 = load i32* %i, align 4, !dbg !51            ; [#uses=1 type=i32] [debug line = 64:17]
  %10 = icmp slt i32 %9, 32, !dbg !51             ; [#uses=1 type=i1] [debug line = 64:17]
  br i1 %10, label %11, label %40, !dbg !51       ; [debug line = 64:17]
...
; <label>:11                                      ; preds = %8
  ...
  %12 = load i32* %i, align 4, !dbg !56           ; [#uses=1 type=i32] [debug line = 65:3]
  %13 = srem i32 %12, 8, !dbg !56                 ; [#uses=1 type=i32] [debug line = 65:3]
  store i32 %13, i32* %rem, align 4, !dbg !56     ; [debug line = 65:3]
  %14 = load i32* %rem, align 4, !dbg !57         ; [#uses=1 type=i32] [debug line = 66:3]
  %15 = sext i32 %14 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 66:3]
  %16 = getelementptr inbounds [8 x i32]* @array_io.acc, i32 0, i64 %15, !dbg !57 ; [#uses=1 type=i32*] [debug line = 66:3]
  %17 = load i32* %16, align 4, !dbg !57          ; [#uses=1 type=i32] [debug line = 66:3]
  %18 = load i32* %i, align 4, !dbg !57           ; [#uses=1 type=i32] [debug line = 66:3]
  %19 = sext i32 %18 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 66:3]
  %20 = load i16** %2, align 8, !dbg !57          ; [#uses=1 type=i16*] [debug line = 66:3]
  %21 = getelementptr inbounds i16* %20, i64 %19, !dbg !57 ; [#uses=1 type=i16*] [debug line = 66:3]
  %22 = load i16* %21, align 2, !dbg !57          ; [#uses=1 type=i16] [debug line = 66:3]
  %23 = sext i16 %22 to i32, !dbg !57             ; [#uses=1 type=i32] [debug line = 66:3]
  %24 = add nsw i32 %17, %23, !dbg !57            ; [#uses=1 type=i32] [debug line = 66:3]
  %25 = load i32* %rem, align 4, !dbg !57         ; [#uses=1 type=i32] [debug line = 66:3]
  %26 = sext i32 %25 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 66:3]
  %27 = getelementptr inbounds [8 x i32]* @array_io.acc, i32 0, i64 %26, !dbg !57 ; [#uses=1 type=i32*] [debug line = 66:3]
  store i32 %24, i32* %27, align 4, !dbg !57      ; [debug line = 66:3]
  %28 = load i32* %rem, align 4, !dbg !58         ; [#uses=1 type=i32] [debug line = 67:3]
  %29 = sext i32 %28 to i64, !dbg !58             ; [#uses=1 type=i64] [debug line = 67:3]
  %30 = getelementptr inbounds [8 x i32]* @array_io.acc, i32 0, i64 %29, !dbg !58 ; [#uses=1 type=i32*] [debug line = 67:3]
  %31 = load i32* %30, align 4, !dbg !58          ; [#uses=1 type=i32] [debug line = 67:3]
  %32 = trunc i32 %31 to i16, !dbg !58            ; [#uses=1 type=i16] [debug line = 67:3]
  %33 = load i32* %i, align 4, !dbg !58           ; [#uses=1 type=i32] [debug line = 67:3]
  %34 = sext i32 %33 to i64, !dbg !58             ; [#uses=1 type=i64] [debug line = 67:3]
  %35 = load i16** %1, align 8, !dbg !58          ; [#uses=1 type=i16*] [debug line = 67:3]
  %36 = getelementptr inbounds i16* %35, i64 %34, !dbg !58 ; [#uses=1 type=i16*] [debug line = 67:3]
  store i16 %32, i16* %36, align 2, !dbg !58      ; [debug line = 67:3]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !59 ; [debug line = 68:2]
  br label %37, !dbg !59                          ; [debug line = 68:2]

; <label>:37                                      ; preds = %11
  %38 = load i32* %i, align 4, !dbg !60           ; [#uses=1 type=i32] [debug line = 64:29]
  %39 = add nsw i32 %38, 1, !dbg !60              ; [#uses=1 type=i32] [debug line = 64:29]
  store i32 %39, i32* %i, align 4, !dbg !60       ; [debug line = 64:29]
  br label %8, !dbg !60                           ; [debug line = 64:29]
