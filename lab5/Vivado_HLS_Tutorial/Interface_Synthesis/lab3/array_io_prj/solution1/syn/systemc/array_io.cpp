...
const sc_lv<5> array_io::ap_ST_fsm_state1 = "1";
const sc_lv<5> array_io::ap_ST_fsm_state2 = "10";
const sc_lv<5> array_io::ap_ST_fsm_state3 = "100";
const sc_lv<5> array_io::ap_ST_fsm_state4 = "1000";
const sc_lv<5> array_io::ap_ST_fsm_state5 = "10000";
...
array_io::array_io(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_1_fu_96_p1);
    sensitive << ( i_reg_64 );

    SC_METHOD(thread_tmp_2_fu_105_p1);
    sensitive << ( d_i_load_reg_145 );

    SC_METHOD(thread_tmp_3_fu_108_p2);
    sensitive << ( acc_load_reg_140 );
    sensitive << ( tmp_2_fu_105_p1 );

    SC_METHOD(thread_tmp_4_fu_113_p2);
    sensitive << ( d_i_load_reg_145 );
    sensitive << ( tmp_6_reg_151 );

    SC_METHOD(thread_tmp_6_fu_101_p1);
    sensitive << ( acc_q0 );
    ...
    sc_trace(mVcdFile, acc_addr_reg_125, "acc_addr_reg_125");
    sc_trace(mVcdFile, exitcond_fu_79_p2, "exitcond_fu_79_p2");
    sc_trace(mVcdFile, tmp_1_fu_96_p1, "tmp_1_fu_96_p1");
    sc_trace(mVcdFile, tmp_1_reg_130, "tmp_1_reg_130");
    sc_trace(mVcdFile, acc_load_reg_140, "acc_load_reg_140");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, d_i_load_reg_145, "d_i_load_reg_145");
    sc_trace(mVcdFile, tmp_6_fu_101_p1, "tmp_6_fu_101_p1");
    ...
    sc_trace(mVcdFile, tmp_4_fu_113_p2, "tmp_4_fu_113_p2");
    sc_trace(mVcdFile, tmp_4_reg_161, "tmp_4_reg_161");
    ...
    sc_trace(mVcdFile, tmp_2_fu_105_p1, "tmp_2_fu_105_p1");
...
void array_io::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state5.read()))) {
        i_reg_64 = i_1_reg_120.read();
    } else if ((esl_seteq<1,1,1>(ap_CS_fsm_state1.read(), ap_const_lv1_1) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        i_reg_64 = ap_const_lv6_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond_fu_79_p2.read(), ap_const_lv1_0))) {
        acc_addr_reg_125 =  (sc_lv<3>) (tmp_fu_91_p1.read());
        tmp_1_reg_130 = tmp_1_fu_96_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()))) {
        acc_load_reg_140 = acc_q0.read();
        d_i_load_reg_145 = d_i_q0.read();
        tmp_6_reg_151 = tmp_6_fu_101_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()))) {
        i_1_reg_120 = i_1_fu_85_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state4.read()))) {
        tmp_3_reg_156 = tmp_3_fu_108_p2.read();
        tmp_4_reg_161 = tmp_4_fu_113_p2.read();
    }
}

void array_io::thread_acc_address0() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state5.read()))) {
        acc_address0 = acc_addr_reg_125.read();
    } else if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()))) {
        acc_address0 =  (sc_lv<3>) (tmp_fu_91_p1.read());
    } else {
        acc_address0 = "XXX";
    }
}
...
void array_io::thread_d_i_address0() {
    d_i_address0 =  (sc_lv<5>) (tmp_1_fu_96_p1.read());
}
...
void array_io::thread_d_o_address0() {
    d_o_address0 =  (sc_lv<5>) (tmp_1_reg_130.read());
}
...
void array_io::thread_exitcond_fu_79_p2() {
    exitcond_fu_79_p2 = (!i_reg_64.read().is_01() || !ap_const_lv6_20.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_64.read() == ap_const_lv6_20);
}

void array_io::thread_i_1_fu_85_p2() {
    i_1_fu_85_p2 = (!ap_const_lv6_1.is_01() || !i_reg_64.read().is_01())? sc_lv<6>(): (sc_biguint<6>(ap_const_lv6_1) + sc_biguint<6>(i_reg_64.read()));
}
...
void array_io::thread_tmp_1_fu_96_p1() {
    tmp_1_fu_96_p1 = esl_zext<64,6>(i_reg_64.read());
}

void array_io::thread_tmp_2_fu_105_p1() {
    tmp_2_fu_105_p1 = esl_sext<32,16>(d_i_load_reg_145.read());
}

void array_io::thread_tmp_3_fu_108_p2() {
    tmp_3_fu_108_p2 = (!acc_load_reg_140.read().is_01() || !tmp_2_fu_105_p1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(acc_load_reg_140.read()) + sc_bigint<32>(tmp_2_fu_105_p1.read()));
}

void array_io::thread_tmp_4_fu_113_p2() {
    tmp_4_fu_113_p2 = (!d_i_load_reg_145.read().is_01() || !tmp_6_reg_151.read().is_01())? sc_lv<16>(): (sc_biguint<16>(d_i_load_reg_145.read()) + sc_biguint<16>(tmp_6_reg_151.read()));
}

void array_io::thread_tmp_6_fu_101_p1() {
    tmp_6_fu_101_p1 = acc_q0.read().range(16-1, 0);
}

void array_io::thread_tmp_fu_91_p1() {
    tmp_fu_91_p1 = esl_zext<64,3>(rem_fu_75_p1.read());
}
