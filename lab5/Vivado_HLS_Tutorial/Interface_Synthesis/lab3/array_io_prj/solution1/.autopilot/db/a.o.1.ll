; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab3/array_io_prj/solution1/.autopilot/db/a.g.1.bc'
...
define void @array_io(i16* %d_o, i16* %d_i) nounwind uwtable {
  ...
  br label %1, !dbg !45                           ; [debug line = 64:17]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %i, 32, !dbg !45        ; [#uses=1 type=i1] [debug line = 64:17]
  br i1 %exitcond, label %3, label %2, !dbg !45   ; [debug line = 64:17]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !47 ; [debug line = 64:35]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !47 ; [#uses=1 type=i32] [debug line = 64:35]
  %rem = srem i32 %i, 8, !dbg !49                 ; [#uses=1 type=i32] [debug line = 65:3]
  call void @llvm.dbg.value(metadata !{i32 %rem}, i64 0, metadata !50), !dbg !49 ; [debug line = 65:3] [debug variable = rem]
  %tmp = sext i32 %rem to i64, !dbg !51           ; [#uses=1 type=i64] [debug line = 66:3]
  %acc.addr = getelementptr inbounds [8 x i32]* @acc, i64 0, i64 %tmp, !dbg !51 ; [#uses=2 type=i32*] [debug line = 66:3]
  %acc.load = load i32* %acc.addr, align 4, !dbg !51 ; [#uses=2 type=i32] [debug line = 66:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %acc.load) nounwind
  %tmp.1 = sext i32 %i to i64, !dbg !51           ; [#uses=2 type=i64] [debug line = 66:3]
  %d_i.addr = getelementptr inbounds i16* %d_i, i64 %tmp.1, !dbg !51 ; [#uses=1 type=i16*] [debug line = 66:3]
  %d_i.load = load i16* %d_i.addr, align 2, !dbg !51 ; [#uses=2 type=i16] [debug line = 66:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %d_i.load) nounwind
  %tmp.2 = sext i16 %d_i.load to i32, !dbg !51    ; [#uses=1 type=i32] [debug line = 66:3]
  %tmp.3 = add nsw i32 %tmp.2, %acc.load, !dbg !51 ; [#uses=3 type=i32] [debug line = 66:3]
  store i32 %tmp.3, i32* %acc.addr, align 4, !dbg !51 ; [debug line = 66:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %tmp.3) nounwind
  %tmp.4 = trunc i32 %tmp.3 to i16, !dbg !52      ; [#uses=1 type=i16] [debug line = 67:3]
  %d_o.addr = getelementptr inbounds i16* %d_o, i64 %tmp.1, !dbg !52 ; [#uses=1 type=i16*] [debug line = 67:3]
  store i16 %tmp.4, i16* %d_o.addr, align 2, !dbg !52 ; [debug line = 67:3]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !53 ; [#uses=0 type=i32] [debug line = 68:2]
  %i.1 = add nsw i32 %i, 1, !dbg !54              ; [#uses=1 type=i32] [debug line = 64:29]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !55), !dbg !54 ; [debug line = 64:29] [debug variable = i]
  br label %1, !dbg !54                           ; [debug line = 64:29]

; <label>:3                                       ; preds = %1
  ret void, !dbg !56                              ; [debug line = 69:1]
}
...
!45 = metadata !{i32 64, i32 17, metadata !46, null}
!46 = metadata !{i32 786443, metadata !43, i32 64, i32 12, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!47 = metadata !{i32 64, i32 35, metadata !48, null}
!48 = metadata !{i32 786443, metadata !46, i32 64, i32 34, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!49 = metadata !{i32 65, i32 3, metadata !48, null}
!50 = metadata !{i32 786688, metadata !43, metadata !"rem", metadata !6, i32 58, metadata !21, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!51 = metadata !{i32 66, i32 3, metadata !48, null}
!52 = metadata !{i32 67, i32 3, metadata !48, null}
!53 = metadata !{i32 68, i32 2, metadata !48, null}
!54 = metadata !{i32 64, i32 29, metadata !46, null}
!55 = metadata !{i32 786688, metadata !43, metadata !"i", metadata !6, i32 58, metadata !21, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!56 = metadata !{i32 69, i32 1, metadata !43, null}
