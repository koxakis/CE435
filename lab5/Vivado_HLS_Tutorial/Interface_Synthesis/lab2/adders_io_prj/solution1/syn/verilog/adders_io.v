...
(* CORE_GENERATION_INFO="adders_io,hls_ip_2016_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.700000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=100,HLS_SYN_LUT=104}" *)
...
initial begin
#0 ap_CS_fsm = 2'b1;
#0 in1_preg = 32'b00000000000000000000000000000000;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state2)) begin
            if (~(1'b0 == ap_sig_ioackin_in_out1_o_ap_ack)) begin
                ap_reg_ioackin_in_out1_o_ap_ack <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & ~(1'b0 == ap_sig_ioackin_in_out1_o_ap_ack))) begin
            in1_ap_vld_preg <= 1'b0;
        end else if (((1'b1 == in1_ap_vld) & ~((1'b0 == ap_start) & (ap_CS_fsm_state1 == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == in1_ap_vld) & ~((1'b0 == ap_start) & (ap_CS_fsm_state1 == 1'b1)))) begin
            in1_preg <= in1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_58 == 1'b1))) begin
...
always @ (*) begin
    ap_condition_58 = ((ap_start == 1'b0) | (in1_ap_vld_in_sig == 1'b0) | (in_out1_i_ap_vld == 1'b0));
end
