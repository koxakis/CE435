...
architecture behav of adders_io is 
    ...
    "adders_io,hls_ip_2016_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.700000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=100,HLS_SYN_LUT=104}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_logic_0 = ap_sig_ioackin_in_out1_o_ap_ack)))) then 
                    in1_ap_vld_preg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = in1_ap_vld) and not(((ap_const_logic_0 = ap_start) and (ap_CS_fsm_state1 = ap_const_lv1_1))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = in1_ap_vld) and not(((ap_const_logic_0 = ap_start) and (ap_CS_fsm_state1 = ap_const_lv1_1))))) then 
                    in1_preg <= in1;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_condition_58 = ap_const_boolean_1)))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_condition_58, ap_sig_ioackin_in_out1_o_ap_ack)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (not((ap_condition_58 = ap_const_boolean_1))) then
    ...
    ap_condition_58_assign_proc : process(ap_start, in1_ap_vld_in_sig, in_out1_i_ap_vld)
    begin
                ap_condition_58 <= ((ap_start = ap_const_logic_0) or (in1_ap_vld_in_sig = ap_const_logic_0) or (in_out1_i_ap_vld = ap_const_logic_0));
    end process;
    ...
    in2_ap_ack_assign_proc : process(ap_CS_fsm_state1, ap_condition_58)
    begin
        if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_condition_58 = ap_const_boolean_1)))) then 
    ...
    in_out1_i_ap_ack_assign_proc : process(ap_CS_fsm_state1, ap_condition_58)
    begin
        if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_condition_58 = ap_const_boolean_1)))) then 
    ...
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (ap_const_logic_0 = ap_reg_ioackin_in_out1_o_ap_ack))) then 
