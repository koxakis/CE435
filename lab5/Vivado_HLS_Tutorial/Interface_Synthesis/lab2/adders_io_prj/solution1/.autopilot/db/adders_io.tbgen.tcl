set C_TypeInfoList {{ 
"adders_io" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in1": [[], {"scalar": "int"}] }, {"in2": [[], {"scalar": "int"}] }, {"in_out1": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
...
set C_modelArgMapList {[ 
	{ "Name" : "in1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in1","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "in_out1", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_out1","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
