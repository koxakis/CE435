set C_TypeInfoList {{ 
"adders" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"in1": [[], {"scalar": "int"}] }, {"in2": [[], {"scalar": "int"}] }, {"in3": [[], {"scalar": "int"}] }],[],""]
}}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.adders_add_32ns_3bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.adders_add_32ns_3bkb_U2", "Parent" : "0"}]}
