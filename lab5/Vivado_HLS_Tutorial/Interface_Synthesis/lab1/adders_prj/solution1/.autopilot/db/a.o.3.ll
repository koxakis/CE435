; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution1/.autopilot/db/a.o.3.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable readnone {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [11 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !40 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, [8 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !42 ; [debug line = 56:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [8 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !43 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [8 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !44 ; [debug line = 58:1]
  %tmp1 = add i32 %in1_read, %in3_read, !dbg !45  ; [#uses=1 type=i32] [debug line = 63:2]
  %sum = add i32 %tmp1, %in2_read, !dbg !45       ; [#uses=1 type=i32] [debug line = 63:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !46), !dbg !45 ; [debug line = 63:2] [debug variable = sum]
  ret i32 %sum, !dbg !47                          ; [debug line = 65:2]
}
...
!42 = metadata !{i32 56, i32 1, metadata !41, null}
!43 = metadata !{i32 57, i32 1, metadata !41, null}
!44 = metadata !{i32 58, i32 1, metadata !41, null}
!45 = metadata !{i32 63, i32 2, metadata !41, null}
!46 = metadata !{i32 786688, metadata !41, metadata !"sum", metadata !29, i32 61, metadata !32, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!47 = metadata !{i32 65, i32 2, metadata !41, null}
