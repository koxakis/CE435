; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/a.o.2.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable readnone {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [13 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !45 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, [8 x i8]* @.str2, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !47 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [8 x i8]* @.str2, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !48 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [8 x i8]* @.str2, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !49 ; [debug line = 59:1]
  %tmp1 = add i32 %in3, %in1, !dbg !50            ; [#uses=1 type=i32] [debug line = 64:2]
  %sum = add i32 %tmp1, %in2, !dbg !50            ; [#uses=1 type=i32] [debug line = 64:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !51), !dbg !50 ; [debug line = 64:2] [debug variable = sum]
  ret i32 %sum, !dbg !52                          ; [debug line = 66:2]
}
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/adders.pragma.2.c", metadata !"/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab1", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !1} ; [ DW_TAG_compile_unit ]
...
!47 = metadata !{i32 57, i32 1, metadata !46, null}
!48 = metadata !{i32 58, i32 1, metadata !46, null}
!49 = metadata !{i32 59, i32 1, metadata !46, null}
!50 = metadata !{i32 64, i32 2, metadata !46, null}
!51 = metadata !{i32 786688, metadata !46, metadata !"sum", metadata !6, i32 62, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!52 = metadata !{i32 66, i32 2, metadata !46, null}
