; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/a.g.1.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !33 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !34 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !35 ; [debug line = 59:1]
  %tmp = add i32 %in2, %in1, !dbg !36             ; [#uses=1 type=i32] [debug line = 64:2]
  %sum = add i32 %tmp, %in3, !dbg !36             ; [#uses=1 type=i32] [debug line = 64:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !37), !dbg !36 ; [debug line = 64:2] [debug variable = sum]
  ret i32 %sum, !dbg !38                          ; [debug line = 66:2]
}
...
!33 = metadata !{i32 57, i32 1, metadata !32, null}
!34 = metadata !{i32 58, i32 1, metadata !32, null}
!35 = metadata !{i32 59, i32 1, metadata !32, null}
!36 = metadata !{i32 64, i32 2, metadata !32, null}
!37 = metadata !{i32 786688, metadata !32, metadata !"sum", metadata !6, i32 62, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!38 = metadata !{i32 66, i32 2, metadata !32, null}
