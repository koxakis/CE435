; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/a.o.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable {
  ...
  %4 = load i32* %3, align 4, !dbg !27            ; [#uses=1 type=i32] [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %4, i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !27 ; [debug line = 57:1]
  %5 = load i32* %2, align 4, !dbg !28            ; [#uses=1 type=i32] [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %5, i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !28 ; [debug line = 58:1]
  %6 = load i32* %1, align 4, !dbg !29            ; [#uses=1 type=i32] [debug line = 59:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %6, i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !29 ; [debug line = 59:1]
  call void @llvm.dbg.declare(metadata !{i32* %sum}, metadata !30), !dbg !31 ; [debug line = 62:6] [debug variable = sum]
  %7 = load i32* %1, align 4, !dbg !32            ; [#uses=1 type=i32] [debug line = 64:2]
  %8 = load i32* %2, align 4, !dbg !32            ; [#uses=1 type=i32] [debug line = 64:2]
  %9 = add nsw i32 %7, %8, !dbg !32               ; [#uses=1 type=i32] [debug line = 64:2]
  %10 = load i32* %3, align 4, !dbg !32           ; [#uses=1 type=i32] [debug line = 64:2]
  %11 = add nsw i32 %9, %10, !dbg !32             ; [#uses=1 type=i32] [debug line = 64:2]
  store i32 %11, i32* %sum, align 4, !dbg !32     ; [debug line = 64:2]
  %12 = load i32* %sum, align 4, !dbg !33         ; [#uses=1 type=i32] [debug line = 66:2]
  ret i32 %12, !dbg !33                           ; [debug line = 66:2]
}
...
!27 = metadata !{i32 57, i32 1, metadata !26, null}
!28 = metadata !{i32 58, i32 1, metadata !26, null}
!29 = metadata !{i32 59, i32 1, metadata !26, null}
!30 = metadata !{i32 786688, metadata !26, metadata !"sum", metadata !6, i32 62, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!31 = metadata !{i32 62, i32 6, metadata !26, null}
!32 = metadata !{i32 64, i32 2, metadata !26, null}
!33 = metadata !{i32 66, i32 2, metadata !26, null}
