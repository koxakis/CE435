; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Interface_Synthesis/lab4/axi_interfaces_prj/solution1/.autopilot/db/a.o.bc'
...
define void @axi_interfaces(i16* %d_o, i16* %d_i) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i16* %5, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  %6 = load i16** %2, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_SpecArrayPartition(i16* %6, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str3, i32 0, i32 0), i32 8, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  %7 = load i16** %1, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %7, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
  %8 = load i16** %1, align 8, !dbg !45           ; [#uses=1 type=i16*] [debug line = 58:1]
  call void (...)* @_ssdm_SpecArrayPartition(i16* %8, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str3, i32 0, i32 0), i32 8, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !45 ; [debug line = 58:1]
...
; <label>:13                                      ; preds = %10
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !55 ; [debug line = 65:1]
  call void (...)* @_ssdm_SpecLoopRewind(i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !56 ; [debug line = 65:41]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 8, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !55 ; [debug line = 65:1]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !60 ; [debug line = 68:2]
