...
architecture behav of axi_interfaces is 
    ...
    "axi_interfaces,hls_ip_2016_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.649000,HLS_SYN_LAT=5,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=884,HLS_SYN_LUT=800}";
    ...
    signal ap_pipeline_reg_pp0_iter1_exitcond_reg_507 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_12_fu_242_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_12_reg_502 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_4_fu_278_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_1_fu_309_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_2_fu_340_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_3_fu_371_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_4_fu_402_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_5_fu_433_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_6_fu_464_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_4_7_fu_495_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal i1_phi_fu_222_p6 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_3_fu_266_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_1_fu_297_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_2_fu_328_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_3_fu_359_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_4_fu_390_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_5_fu_421_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_6_fu_452_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_7_fu_483_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i1_cast_fu_232_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_1_7_fu_236_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_2_fu_258_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_262_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_1_fu_289_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_fu_293_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_2_fu_320_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_324_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_3_fu_351_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_7_fu_355_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_4_fu_382_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_8_fu_386_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_5_fu_413_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_9_fu_417_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_6_fu_444_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_10_fu_448_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2_7_fu_475_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_done_assign_proc : process(ap_condition_67, d_o_0_1_ack_in, d_o_1_1_ack_in, d_o_2_1_ack_in, d_o_3_1_ack_in, d_o_4_1_ack_in, d_o_5_1_ack_in, d_o_6_1_ack_in, d_o_7_1_ack_in, ap_enable_reg_pp0_iter1, ap_condition_127, ap_pipeline_reg_pp0_iter1_exitcond_reg_507, ap_enable_reg_pp0_iter2)
    begin
        if ((not((ap_const_lv1_0 = ap_pipeline_reg_pp0_iter1_exitcond_reg_507)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2) and not(((((ap_condition_67 = ap_const_boolean_1) or (ap_const_logic_0 = d_o_0_1_ack_in) or (ap_const_logic_0 = d_o_1_1_ack_in) or (ap_const_logic_0 = d_o_2_1_ack_in) or (ap_const_logic_0 = d_o_3_1_ack_in) or (ap_const_logic_0 = d_o_4_1_ack_in) or (ap_const_logic_0 = d_o_5_1_ack_in) or (ap_const_logic_0 = d_o_6_1_ack_in) or (ap_const_logic_0 = d_o_7_1_ack_in)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)) or (((ap_const_logic_0 = d_o_0_1_ack_in) or (ap_const_logic_0 = d_o_1_1_ack_in) or (ap_const_logic_0 = d_o_2_1_ack_in) or (ap_const_logic_0 = d_o_3_1_ack_in) or (ap_const_logic_0 = d_o_4_1_ack_in) or (ap_const_logic_0 = d_o_5_1_ack_in) or (ap_const_logic_0 = d_o_6_1_ack_in) or (ap_const_logic_0 = d_o_7_1_ack_in) or (ap_condition_127 = ap_const_boolean_1)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2)))))) then 
    ...
    ap_ready_assign_proc : process(exitcond_fu_246_p2, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_condition_67, d_o_0_1_ack_in, d_o_1_1_ack_in, d_o_2_1_ack_in, d_o_3_1_ack_in, d_o_4_1_ack_in, d_o_5_1_ack_in, d_o_6_1_ack_in, d_o_7_1_ack_in, ap_enable_reg_pp0_iter1, ap_condition_127, ap_enable_reg_pp0_iter2)
    begin
        if ((not((exitcond_fu_246_p2 = ap_const_lv1_0)) and (ap_const_lv1_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and not(((((ap_condition_67 = ap_const_boolean_1) or (ap_const_logic_0 = d_o_0_1_ack_in) or (ap_const_logic_0 = d_o_1_1_ack_in) or (ap_const_logic_0 = d_o_2_1_ack_in) or (ap_const_logic_0 = d_o_3_1_ack_in) or (ap_const_logic_0 = d_o_4_1_ack_in) or (ap_const_logic_0 = d_o_5_1_ack_in) or (ap_const_logic_0 = d_o_6_1_ack_in) or (ap_const_logic_0 = d_o_7_1_ack_in)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)) or (((ap_const_logic_0 = d_o_0_1_ack_in) or (ap_const_logic_0 = d_o_1_1_ack_in) or (ap_const_logic_0 = d_o_2_1_ack_in) or (ap_const_logic_0 = d_o_3_1_ack_in) or (ap_const_logic_0 = d_o_4_1_ack_in) or (ap_const_logic_0 = d_o_5_1_ack_in) or (ap_const_logic_0 = d_o_6_1_ack_in) or (ap_const_logic_0 = d_o_7_1_ack_in) or (ap_condition_127 = ap_const_boolean_1)) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2)))))) then 
    ...
    i1_cast_fu_232_p1 <= std_logic_vector(resize(unsigned(i1_phi_fu_222_p6),6));

    i1_phi_fu_222_p6_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond_reg_507, i1_reg_218, tmp_12_reg_502)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1))) then
            if (not((ap_const_lv1_0 = exitcond_reg_507))) then 
    ...
    tmp_10_fu_448_p1 <= acc_6(16 - 1 downto 0);
    tmp_11_fu_479_p1 <= acc_7(16 - 1 downto 0);
    tmp_12_fu_242_p1 <= i_1_7_fu_236_p2(5 - 1 downto 0);
    tmp_1_fu_262_p1 <= acc_0(16 - 1 downto 0);
        tmp_2_1_fu_289_p1 <= std_logic_vector(resize(signed(d_i_1_0_data_out),32));

        tmp_2_2_fu_320_p1 <= std_logic_vector(resize(signed(d_i_2_0_data_out),32));

        tmp_2_3_fu_351_p1 <= std_logic_vector(resize(signed(d_i_3_0_data_out),32));

        tmp_2_4_fu_382_p1 <= std_logic_vector(resize(signed(d_i_4_0_data_out),32));

        tmp_2_5_fu_413_p1 <= std_logic_vector(resize(signed(d_i_5_0_data_out),32));

        tmp_2_6_fu_444_p1 <= std_logic_vector(resize(signed(d_i_6_0_data_out),32));

        tmp_2_7_fu_475_p1 <= std_logic_vector(resize(signed(d_i_7_0_data_out),32));

        tmp_2_fu_258_p1 <= std_logic_vector(resize(signed(d_i_0_0_data_out),32));

    tmp_3_1_fu_297_p2 <= std_logic_vector(signed(tmp_2_1_fu_289_p1) + signed(acc_1));
    tmp_3_2_fu_328_p2 <= std_logic_vector(signed(tmp_2_2_fu_320_p1) + signed(acc_2));
    tmp_3_3_fu_359_p2 <= std_logic_vector(signed(tmp_2_3_fu_351_p1) + signed(acc_3));
    tmp_3_4_fu_390_p2 <= std_logic_vector(signed(tmp_2_4_fu_382_p1) + signed(acc_4));
    tmp_3_5_fu_421_p2 <= std_logic_vector(signed(tmp_2_5_fu_413_p1) + signed(acc_5));
    tmp_3_6_fu_452_p2 <= std_logic_vector(signed(tmp_2_6_fu_444_p1) + signed(acc_6));
    tmp_3_7_fu_483_p2 <= std_logic_vector(signed(tmp_2_7_fu_475_p1) + signed(acc_7));
    tmp_3_fu_266_p2 <= std_logic_vector(signed(tmp_2_fu_258_p1) + signed(acc_0));
    tmp_4_1_fu_309_p2 <= std_logic_vector(unsigned(tmp_5_fu_293_p1) + unsigned(d_i_1_0_data_out));
    tmp_4_2_fu_340_p2 <= std_logic_vector(unsigned(tmp_6_fu_324_p1) + unsigned(d_i_2_0_data_out));
    tmp_4_3_fu_371_p2 <= std_logic_vector(unsigned(tmp_7_fu_355_p1) + unsigned(d_i_3_0_data_out));
    tmp_4_4_fu_402_p2 <= std_logic_vector(unsigned(tmp_8_fu_386_p1) + unsigned(d_i_4_0_data_out));
    tmp_4_5_fu_433_p2 <= std_logic_vector(unsigned(tmp_9_fu_417_p1) + unsigned(d_i_5_0_data_out));
    tmp_4_6_fu_464_p2 <= std_logic_vector(unsigned(tmp_10_fu_448_p1) + unsigned(d_i_6_0_data_out));
    tmp_4_7_fu_495_p2 <= std_logic_vector(unsigned(tmp_11_fu_479_p1) + unsigned(d_i_7_0_data_out));
    tmp_4_fu_278_p2 <= std_logic_vector(unsigned(tmp_1_fu_262_p1) + unsigned(d_i_0_0_data_out));
    tmp_5_fu_293_p1 <= acc_1(16 - 1 downto 0);
    tmp_6_fu_324_p1 <= acc_2(16 - 1 downto 0);
    tmp_7_fu_355_p1 <= acc_3(16 - 1 downto 0);
    tmp_8_fu_386_p1 <= acc_4(16 - 1 downto 0);
    tmp_9_fu_417_p1 <= acc_5(16 - 1 downto 0);
end behav;
