...
architecture behav of fir is 
    ...
    "fir,hls_ip_2016_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.430000,HLS_SYN_LAT=78,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=243,HLS_SYN_LUT=159}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state3) and (tmp_1_reg_187 = ap_const_lv1_0))) then 
    ...
    shift_reg_we0_assign_proc : process(ap_CS_fsm_state2, tmp_1_fu_143_p2, tmp_1_reg_187, tmp_fu_135_p3, ap_CS_fsm_state3)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state3) and (tmp_1_reg_187 = ap_const_lv1_0)) or ((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_135_p3 = ap_const_lv1_0) and not((tmp_1_fu_143_p2 = ap_const_lv1_0))))) then 
