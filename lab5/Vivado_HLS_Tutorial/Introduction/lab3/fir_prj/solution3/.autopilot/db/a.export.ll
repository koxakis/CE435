...
define void @fir(i32* %y, [11 x i32]* %c, i32 %x) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %y, [7 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i32 %x, [7 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  ...
  %tmp_6 = mul nsw i32 %shift_reg_9_load, %c_load
  ...
  %tmp_6_1 = mul nsw i32 %shift_reg_8_load, %c_load_1
  ...
  %tmp_6_2 = mul nsw i32 %shift_reg_7_load, %c_load_2
  ...
  %tmp_6_3 = mul nsw i32 %shift_reg_6_load, %c_load_3
  ...
  %tmp_6_4 = mul nsw i32 %shift_reg_5_load, %c_load_4
  ...
  %tmp_6_5 = mul nsw i32 %shift_reg_4_load, %c_load_5
  ...
  %tmp_6_6 = mul nsw i32 %shift_reg_3_load, %c_load_6
  ...
  %tmp_6_7 = mul nsw i32 %shift_reg_2_load, %c_load_7
  ...
  %tmp_6_8 = mul nsw i32 %shift_reg_1_load, %c_load_8
  ...
  %tmp_6_9 = mul nsw i32 %shift_reg_0_load, %c_load_9
