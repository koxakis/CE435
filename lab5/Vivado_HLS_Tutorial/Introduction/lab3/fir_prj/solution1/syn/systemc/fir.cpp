...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_3bkb_U1->din0(c_load_reg_211);
    fir_mul_32s_32s_3bkb_U1->din1(data1_reg_114);
    fir_mul_32s_32s_3bkb_U1->ce(ap_var_for_const0);
    fir_mul_32s_32s_3bkb_U1->dout(grp_fu_162_p2);
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_135_p3.read(), ap_const_lv1_0))) {
