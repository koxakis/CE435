; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution1/.autopilot/db/a.g.1.bc'
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 60:45]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !39 ; [#uses=1 type=i32] [debug line = 60:45]
  %tmp.1 = icmp eq i32 %i, 0, !dbg !41            ; [#uses=1 type=i1] [debug line = 61:3]
  br i1 %tmp.1, label %3, label %4, !dbg !41      ; [debug line = 61:3]

; <label>:3                                       ; preds = %2
  store i32 %x, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16, !dbg !42 ; [debug line = 62:4]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !44), !dbg !45 ; [debug line = 63:4] [debug variable = data]
  br label %5, !dbg !46                           ; [debug line = 64:5]

; <label>:4                                       ; preds = %2
  %tmp.2 = add nsw i32 %i, -1, !dbg !47           ; [#uses=1 type=i32] [debug line = 65:4]
  %tmp.3 = sext i32 %tmp.2 to i64, !dbg !47       ; [#uses=1 type=i64] [debug line = 65:4]
  %shift_reg.addr = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp.3, !dbg !47 ; [#uses=1 type=i32*] [debug line = 65:4]
  ...
  %tmp.4 = sext i32 %i to i64, !dbg !47           ; [#uses=1 type=i64] [debug line = 65:4]
  %shift_reg.addr.1 = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp.4, !dbg !47 ; [#uses=1 type=i32*] [debug line = 65:4]
...
; <label>:5                                       ; preds = %4, %3
  ...
  %tmp.5 = sext i32 %i to i64, !dbg !50           ; [#uses=1 type=i64] [debug line = 68:5]
  %c.addr = getelementptr inbounds i32* %c, i64 %tmp.5, !dbg !50 ; [#uses=1 type=i32*] [debug line = 68:5]
  ...
  %tmp.6 = mul nsw i32 %c.load, %data1, !dbg !50  ; [#uses=1 type=i32] [debug line = 68:5]
  %acc.1 = add nsw i32 %tmp.6, %acc, !dbg !50     ; [#uses=1 type=i32] [debug line = 68:5]
  call void @llvm.dbg.value(metadata !{i32 %acc.1}, i64 0, metadata !51), !dbg !50 ; [debug line = 68:5] [debug variable = acc]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !53 ; [#uses=0 type=i32] [debug line = 69:3]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution1/.autopilot/db/fir.pragma.2.c", metadata !"/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !16} ; [ DW_TAG_compile_unit ]
...
!41 = metadata !{i32 61, i32 3, metadata !40, null}
!42 = metadata !{i32 62, i32 4, metadata !43, null}
!43 = metadata !{i32 786443, metadata !40, i32 61, i32 13, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!44 = metadata !{i32 786688, metadata !36, metadata !"data", metadata !6, i32 56, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!45 = metadata !{i32 63, i32 4, metadata !43, null}
