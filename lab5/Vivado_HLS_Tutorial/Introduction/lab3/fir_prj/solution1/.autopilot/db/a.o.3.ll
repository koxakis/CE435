; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_1 = icmp eq i5 %i, 0, !dbg !50             ; [#uses=1 type=i1] [debug line = 61:3]
  br i1 %tmp_1, label %3, label %4, !dbg !50      ; [debug line = 61:3]

; <label>:3                                       ; preds = %2
  store i32 %x_read, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16, !dbg !51 ; [debug line = 62:4]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !53), !dbg !54 ; [debug line = 63:4] [debug variable = data]
...
!50 = metadata !{i32 61, i32 3, metadata !49, null}
!51 = metadata !{i32 62, i32 4, metadata !52, null}
!52 = metadata !{i32 786443, metadata !49, i32 61, i32 13, metadata !27, i32 3} ; [ DW_TAG_lexical_block ]
!53 = metadata !{i32 786688, metadata !47, metadata !"data", metadata !27, i32 56, metadata !31, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!54 = metadata !{i32 63, i32 4, metadata !52, null}
