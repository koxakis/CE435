; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution1/.autopilot/db/a.g.bc'
...
; <label>:9                                       ; preds = %6
  ...
  %10 = load i32* %i, align 4, !dbg !49           ; [#uses=1 type=i32] [debug line = 61:3]
  %11 = icmp eq i32 %10, 0, !dbg !49              ; [#uses=1 type=i1] [debug line = 61:3]
  br i1 %11, label %12, label %15, !dbg !49       ; [debug line = 61:3]
...
; <label>:12                                      ; preds = %9
  ...
  %14 = load i32* %3, align 4, !dbg !52           ; [#uses=1 type=i32] [debug line = 63:4]
  store i32 %14, i32* %data, align 4, !dbg !52    ; [debug line = 63:4]
...
!49 = metadata !{i32 61, i32 3, metadata !48, null}
!50 = metadata !{i32 62, i32 4, metadata !51, null}
!51 = metadata !{i32 786443, metadata !48, i32 61, i32 13, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!52 = metadata !{i32 63, i32 4, metadata !51, null}
