; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.1 = icmp eq i5 %i, 0, !dbg !55             ; [#uses=1 type=i1] [debug line = 61:3]
  br i1 %tmp.1, label %4, label %5, !dbg !55      ; [debug line = 61:3]

; <label>:4                                       ; preds = %3
  store i32 %x, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16, !dbg !56 ; [debug line = 62:4]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !58), !dbg !59 ; [debug line = 63:4] [debug variable = data]
...
!55 = metadata !{i32 61, i32 3, metadata !54, null}
!56 = metadata !{i32 62, i32 4, metadata !57, null}
!57 = metadata !{i32 786443, metadata !54, i32 61, i32 13, metadata !12, i32 3} ; [ DW_TAG_lexical_block ]
!58 = metadata !{i32 786688, metadata !52, metadata !"data", metadata !12, i32 56, metadata !16, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!59 = metadata !{i32 63, i32 4, metadata !57, null}
