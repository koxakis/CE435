...
architecture behav of fir is 
    ...
    "fir,hls_ip_2016_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.430000,HLS_SYN_LAT=78,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=276,HLS_SYN_LUT=194}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((tmp_fu_147_p3 = ap_const_lv1_0)))) then 
                    x_ap_vld_preg <= ap_const_logic_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_CS_fsm_state1 = ap_const_lv1_1) and not(((ap_start = ap_const_logic_0) or (x_ap_vld_in_sig = ap_const_logic_0))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state3) and (tmp_1_reg_199 = ap_const_lv1_0))) then 
                data1_reg_126 <= shift_reg_q0;
            elsif (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_147_p3 = ap_const_lv1_0) and not((tmp_1_fu_155_p2 = ap_const_lv1_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_147_p3 = ap_const_lv1_0))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, x_ap_vld_in_sig, tmp_fu_147_p3)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (not(((ap_start = ap_const_logic_0) or (x_ap_vld_in_sig = ap_const_logic_0)))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (not((tmp_fu_147_p3 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    grp_fu_136_p2 <= std_logic_vector(unsigned(grp_fu_136_p0) + unsigned(ap_const_lv5_1F));
        i_cast_fu_143_p1 <= std_logic_vector(resize(signed(i_reg_114),32));
    ...
    begin
        ...
        elsif (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_147_p3 = ap_const_lv1_0) and (tmp_1_fu_155_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_147_p3 = ap_const_lv1_0) and (tmp_1_fu_155_p2 = ap_const_lv1_0)) or ((ap_const_lv1_1 = ap_CS_fsm_state3)) or ((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_147_p3 = ap_const_lv1_0) and not((tmp_1_fu_155_p2 = ap_const_lv1_0))))) then 
    ...
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state3) and (tmp_1_reg_199 = ap_const_lv1_0)) or ((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_147_p3 = ap_const_lv1_0) and not((tmp_1_fu_155_p2 = ap_const_lv1_0))))) then 
    ...
    tmp_3_fu_161_p1 <= std_logic_vector(resize(unsigned(grp_fu_136_p2),64));
    tmp_4_fu_166_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_190),64));
    tmp_5_fu_170_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_190),64));
