; ModuleID = '/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3/fir_prj/solution2/.autopilot/db/a.o.2.bc'
...
define void @fir(i32* %y, [11 x i32]* %c, i32 %x) nounwind uwtable {
  ...
  br label %1, !dbg !53                           ; [debug line = 63:26]

; <label>:1                                       ; preds = %6, %0
  %acc = phi i32 [ 0, %0 ], [ %acc.1, %6 ]        ; [#uses=2 type=i32]
  %i = phi i5 [ 10, %0 ], [ %i.1, %6 ]            ; [#uses=5 type=i5]
  %i.cast = sext i5 %i to i32, !dbg !53           ; [#uses=2 type=i32] [debug line = 63:26]
  %tmp = icmp sgt i5 %i, -1, !dbg !53             ; [#uses=1 type=i1] [debug line = 63:26]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) nounwind ; [#uses=0 type=i32]
  br i1 %tmp, label %3, label %7, !dbg !53        ; [debug line = 63:26]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([17 x i8]* @.str3) nounwind, !dbg !55 ; [debug line = 63:45]
  %tmp.1 = icmp eq i5 %i, 0, !dbg !57             ; [#uses=1 type=i1] [debug line = 64:3]
  br i1 %tmp.1, label %4, label %5, !dbg !57      ; [debug line = 64:3]

; <label>:4                                       ; preds = %3
  store i32 %x, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16, !dbg !58 ; [debug line = 65:4]
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !60), !dbg !61 ; [debug line = 66:4] [debug variable = data]
  br label %6, !dbg !62                           ; [debug line = 67:5]

; <label>:5                                       ; preds = %3
  %tmp.2 = add i5 %i, -1, !dbg !63                ; [#uses=1 type=i5] [debug line = 68:4]
  %tmp.3 = zext i5 %tmp.2 to i64, !dbg !63        ; [#uses=1 type=i64] [debug line = 68:4]
  %shift_reg.addr = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp.3, !dbg !63 ; [#uses=1 type=i32*] [debug line = 68:4]
  %data = load i32* %shift_reg.addr, align 4, !dbg !63 ; [#uses=2 type=i32] [debug line = 68:4]
  %tmp.4 = zext i32 %i.cast to i64, !dbg !63      ; [#uses=1 type=i64] [debug line = 68:4]
  %shift_reg.addr.1 = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp.4, !dbg !63 ; [#uses=1 type=i32*] [debug line = 68:4]
  store i32 %data, i32* %shift_reg.addr.1, align 4, !dbg !63 ; [debug line = 68:4]
  call void @llvm.dbg.value(metadata !{i32 %data}, i64 0, metadata !60), !dbg !65 ; [debug line = 69:4] [debug variable = data]
  br label %6

; <label>:6                                       ; preds = %5, %4
  %data1 = phi i32 [ %x, %4 ], [ %data, %5 ]      ; [#uses=1 type=i32]
  %tmp.5 = zext i32 %i.cast to i64, !dbg !66      ; [#uses=1 type=i64] [debug line = 71:5]
  %c.addr = getelementptr [11 x i32]* %c, i64 0, i64 %tmp.5, !dbg !66 ; [#uses=1 type=i32*] [debug line = 71:5]
  %c.load = load i32* %c.addr, align 4, !dbg !66  ; [#uses=1 type=i32] [debug line = 71:5]
  %tmp.6 = mul nsw i32 %data1, %c.load, !dbg !66  ; [#uses=1 type=i32] [debug line = 71:5]
  %acc.1 = add nsw i32 %acc, %tmp.6, !dbg !66     ; [#uses=1 type=i32] [debug line = 71:5]
  call void @llvm.dbg.value(metadata !{i32 %acc.1}, i64 0, metadata !67), !dbg !66 ; [debug line = 71:5] [debug variable = acc]
  %i.1 = add i5 %i, -1, !dbg !69                  ; [#uses=1 type=i5] [debug line = 63:39]
  call void @llvm.dbg.value(metadata !{i5 %i.1}, i64 0, metadata !70), !dbg !69 ; [debug line = 63:39] [debug variable = i]
  br label %1, !dbg !69                           ; [debug line = 63:39]

; <label>:7                                       ; preds = %1
  %acc.lcssa = phi i32 [ %acc, %1 ]               ; [#uses=1 type=i32]
  store i32 %acc.lcssa, i32* %y, align 4, !dbg !71 ; [debug line = 73:3]
  ret void, !dbg !72                              ; [debug line = 74:1]
}
...
!10 = metadata !{i32 786484, i32 0, metadata !11, metadata !"shift_reg", metadata !"shift_reg", metadata !"", metadata !12, i32 57, metadata !22, i32 1, i32 1, [11 x i32]* @shift_reg} ; [ DW_TAG_variable ]
...
!12 = metadata !{i32 786473, metadata !"fir.c", metadata !"/home/nikolas/Git_Repos/CE435/lab5/Vivado_HLS_Tutorial/Introduction/lab3", null} ; [ DW_TAG_file_type ]
...
!51 = metadata !{i32 786443, metadata !11, i32 52, i32 5, metadata !12, i32 0} ; [ DW_TAG_lexical_block ]
!52 = metadata !{i32 54, i32 1, metadata !51, null}
!53 = metadata !{i32 63, i32 26, metadata !54, null}
!54 = metadata !{i32 786443, metadata !51, i32 63, i32 21, metadata !12, i32 1} ; [ DW_TAG_lexical_block ]
!55 = metadata !{i32 63, i32 45, metadata !56, null}
!56 = metadata !{i32 786443, metadata !54, i32 63, i32 44, metadata !12, i32 2} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 64, i32 3, metadata !56, null}
!58 = metadata !{i32 65, i32 4, metadata !59, null}
!59 = metadata !{i32 786443, metadata !56, i32 64, i32 13, metadata !12, i32 3} ; [ DW_TAG_lexical_block ]
!60 = metadata !{i32 786688, metadata !51, metadata !"data", metadata !12, i32 59, metadata !16, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!61 = metadata !{i32 66, i32 4, metadata !59, null}
!62 = metadata !{i32 67, i32 5, metadata !59, null}
!63 = metadata !{i32 68, i32 4, metadata !64, null}
!64 = metadata !{i32 786443, metadata !56, i32 67, i32 12, metadata !12, i32 4} ; [ DW_TAG_lexical_block ]
!65 = metadata !{i32 69, i32 4, metadata !64, null}
!66 = metadata !{i32 71, i32 5, metadata !56, null}
!67 = metadata !{i32 786688, metadata !51, metadata !"acc", metadata !12, i32 58, metadata !68, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!68 = metadata !{i32 786454, null, metadata !"acc_t", metadata !12, i32 52, i64 0, i64 0, i64 0, i32 0, metadata !17} ; [ DW_TAG_typedef ]
!69 = metadata !{i32 63, i32 39, metadata !54, null}
!70 = metadata !{i32 786688, metadata !51, metadata !"i", metadata !12, i32 60, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!71 = metadata !{i32 73, i32 3, metadata !51, null}
!72 = metadata !{i32 74, i32 1, metadata !51, null}
