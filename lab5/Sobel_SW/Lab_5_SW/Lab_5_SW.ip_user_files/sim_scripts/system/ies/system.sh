...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Lab_5_SW.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"$ref_dir/../../../../Lab_5_SW.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../Lab_5_SW.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"../../../../Lab_5_SW.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
