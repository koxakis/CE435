...
HD_PWD='/run/media/nikolas/Linux_Data/CE435_vidado_labs/Lab_1/step_4/project/step_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GrayCounter_System.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GrayCounter_System.tcl
