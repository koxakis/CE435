...
HD_PWD='/run/media/nikolas/Linux_Data/CE435_vidado_labs/Lab_1/step_6/project/step_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GrayCounter_System.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GrayCounter_System.tcl -notrace
