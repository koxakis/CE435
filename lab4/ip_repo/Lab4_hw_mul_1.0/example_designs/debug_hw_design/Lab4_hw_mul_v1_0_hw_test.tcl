# Runtime Tcl commands to interact with - Lab4_hw_mul_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/Lab4_hw_mul_v1_0_include.tcl
...
# Test: Lab4_hw_mul
# Create a write transaction at lab4_hw_mul_addr address
create_hw_axi_txn w_lab4_hw_mul_addr [get_hw_axis $jtag_axi_master] -type write -address $lab4_hw_mul_addr -data $wdata_1
# Create a read transaction at lab4_hw_mul_addr address
create_hw_axi_txn r_lab4_hw_mul_addr [get_hw_axis $jtag_axi_master] -type read -address $lab4_hw_mul_addr
# Initiate transactions
run_hw_axi r_lab4_hw_mul_addr
run_hw_axi w_lab4_hw_mul_addr
run_hw_axi r_lab4_hw_mul_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_lab4_hw_mul_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - Lab4_hw_mul"
} else {
	puts "Data comparison test fail for - Lab4_hw_mul, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
