...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of Lab4_hw_mul_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins Lab4_hw_mul_0/Lab4_hw_mul]
	connect_bd_net [get_bd_pins Lab4_hw_mul_0/lab4_hw_mul_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Lab4_hw_mul_0/lab4_hw_mul_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins Lab4_hw_mul_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins Lab4_hw_mul_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins Lab4_hw_mul_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	connect_bd_net [get_bd_pins Lab4_hw_mul_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Copy all address to Lab4_hw_mul_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/Lab4_hw_mul_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Lab4_hw_mul_0_Lab4_hw_mul_* ]]
	puts $fp "set lab4_hw_mul_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_Lab4_hw_mul_0_S_AXI_INTR_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/Lab4_hw_mul_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "Lab4_hw_mul_v1_0_hw_${i}"
