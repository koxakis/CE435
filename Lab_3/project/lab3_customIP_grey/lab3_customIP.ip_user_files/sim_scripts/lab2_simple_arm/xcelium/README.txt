...
#
# Generated by export_simulation on Fri Apr 05 16:25:32 EEST 2019
#
################################################################################
...
'-reset_run' switch to the './lab2_simple_arm.sh' script.

./lab2_simple_arm.sh -reset_run
...
./lab2_simple_arm.sh -noclean_files

For more information on the script, please type './lab2_simple_arm.sh -help'.
