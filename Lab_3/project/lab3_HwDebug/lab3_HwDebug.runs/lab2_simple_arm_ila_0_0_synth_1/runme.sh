...
HD_PWD='/run/media/nikolas/Linux_Data/CE435_vidado_labs/Lab_3/project/lab3_HwDebug/lab3_HwDebug.runs/lab2_simple_arm_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_simple_arm_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_simple_arm_ila_0_0.tcl
